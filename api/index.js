...
// mongoose.connect("mongodb+srv://ganeshkasture64:ganesh@cluster0.rvyye.mongodb.net/").then(() => {
//     console.log("connected to mongodb database")
// }).catch((error) => {
//     console.log(error, "error connectiong to the mongo db")
// })
...
//         text: `Please click on the following link to verify your email : http://localhost:3000/verify/${verificationTocken}`
//     }
...
mongoose
    .connect("mongodb+srv://ganeshkasture:ganesh@cluster0.8ocas.mongodb.net/")
    .then(() => {
